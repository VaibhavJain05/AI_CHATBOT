...
Instruction: Based on the above documents, provide a detailed answer for the user's question below. \
Include the source or an excerpt from the document when forming the answer. \
Answer 'don't know' if the information is not present in the document."""
...
Nếu câu trả lời được lấy từ bối cảnh, trợ lí phải chỉ rõ nguồn hoặc trích dẫn từ tài liệu liên quan."""
...
Bao gồm nguồn hoặc trích dẫn từ tài liệu liên quan khi đưa ra câu trả lời. \
